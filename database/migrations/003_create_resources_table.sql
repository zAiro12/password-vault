...
-- The 'resource_type' field is flexible to accommodate various resource types
CREATE TABLE IF NOT EXISTS resources (
  ...
  resource_type VARCHAR(50),                 -- Resource type (e.g., "server", "database", "vm", "saas")
  ...
  url TEXT,                                  -- Resource URL (for web/SaaS resources)
